...
public class InitConfig
{
    ...
    public void init()
    {
        Stack spring = Stack.builder()
                .name("Spring")
                .imageUrl(springUrl)
                .selected(true)
                .build();

        Stack mySql = Stack.builder()
                .name("MySql")
                .imageUrl(mySqlUrl)
                .selected(true)
                .build();

        Stack java = Stack.builder()
                .name("Java")
                .imageUrl(javaUrl)
                .selected(true)
                .build();

        Stack typeScript = Stack.builder()
                .name("TypeScript")
                .imageUrl(typeScriptUrl)
                .selected(false)
                .build();

        Stack flask = Stack.builder()
                .name("Flask")
                .imageUrl(flaskUrl)
                .selected(false)
                .build();
